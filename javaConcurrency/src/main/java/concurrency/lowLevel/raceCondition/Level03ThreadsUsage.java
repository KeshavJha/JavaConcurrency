...
public class Level03ThreadsUsage {
...
//		public synchronized void run() { // Step of @NOTE POINT 1 .... Had tried making this as synchronized
		public void run() {
//			try {
//				Thread.sleep(200);
//			} catch (InterruptedException e) {
...
//				e.printStackTrace();
//			}
			synchronized(Level03ThreadsUsage.class) {
				...
				// Pay attention , yahaan synchronized block kaise likhe hain specific class pe
				 // @NOTE POINT 1 :  But not if this method is synchronized. --- Nakko ji , tried making run() synchronized -- as well as this block as synchronized , but Still value 1 is visible . REASON - counter to nahi hai na synchronized ; two separate operations on counter value which means probably counter itself should be synchronized.
								// Dhyaan de , ki kewal ek jagah synchronize karne se kuchh nahi hoga. Dono jagah karna hoga , nahi to dusraa ko unrestricted access rahega. .... and still you would see 1 value accessed by Task 1
