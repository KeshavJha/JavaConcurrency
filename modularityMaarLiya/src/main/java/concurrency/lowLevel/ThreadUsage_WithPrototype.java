...
public class ThreadUsage_WithPrototype {
	protected int counter = 0; // NOTE : protected hoga to child class able to access
//	Class<? extends ThreadUsage_WithPrototype> clas = ThreadUsage_WithPrototype.class; // Not needed with non static variables and methods
	...
	public static void main(String[] args) {
		...
		ThreadUsage_WithPrototype p1 = new ThreadUsage_WithPrototype();
		p1.invokeDriver();
//		IntStream.rangeClosed(1, 100).forEach(x -> competingThreadsWithJoin.accept(x)); // With Join there is atleast some order in the disorder .. Kabhi 0 , kabhi 1 , kabhi 2 ... bas 3 states hi.
	...
	public void invokeDriver() {
		IntStream.rangeClosed(1, 100).forEach(x -> competingThreadsWithJoin.accept(x)); 
	}
	...
	IntConsumer competingThreadsWithoutJoin = new IntConsumer() {

		@Override
		public void accept(int value) {

			Thread th1 = new Thread(getTask1());
			Thread th2 = new Thread(getTask2());
			th1.start(); 
			th2.start(); 
	...
	IntConsumer competingThreadsWithJoin = new IntConsumer() {

		@Override
		public void accept(int value) {

//			Thread th1 = new Thread(clas.getClass().getClgetTask1()); // NOTE : Can't invoke a method directly on the class , need to call another function;
			Thread th1 = new Thread(getTask1());
			Thread th2 = new Thread(getTask2());
			th1.start(); 
			th2.start(); 
...
//			counter = 0; // If counter=0 is used here  ... counter of parent class is set to zero. Need to delegate this as well , like getTask1() & getTask2()
			resetCounter();
			System.out.println("******");
